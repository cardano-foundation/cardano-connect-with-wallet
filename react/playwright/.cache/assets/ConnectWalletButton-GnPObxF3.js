import { y as yt, r as reactExports, j as jsxRuntimeExports, R as React2, c as checkIsMobile, e as estimateAvailableWallets, U as UnavailableWalletVisibility, W as WalletExtensionNotFoundError, g as getWalletConfig, a as chromeStoreUrl, m as mobileWallets, i as isWalletInstalled, b as generateCip158DeepLink, d as getWalletIcon, f as capitalize, h as formatSupportedWallets } from './index-Dcr_zcAl.js';
import { c as composeRefs, a as createContextScope, u as useComposedRefs, r as reactDomExports, P as Primitive, b as useLayoutEffect2, d as useCallbackRef, e as useControllableState, f as composeEventHandlers, g as useId, h as Presence, i as Portal$1, j as hideOthers, R as ReactRemoveScroll, k as useFocusGuards, F as FocusScope, D as DismissableLayer, l as dispatchDiscreteCustomEvent, m as useCardano, n as getMobileOS, C as Color, M as ModalDialog } from './common-DRPlBVDz.js';
...
const Menu$1 = yt.div`
  ...
  margin-top: 8px;
`;
const MenuItem$1 = yt("div").withConfig({
  shouldForwardProp: (prop) => !["primaryColor", "primaryColorLight", "borderRadius"].includes(prop)
})`
...
const MenuItemIcon = yt.img`
  ...
  margin-right: 8px;
`;
const Button = yt("button").withConfig({
  shouldForwardProp: (prop) => !["primaryColor", "customCSS", "borderRadius"].includes(prop)
})`
  padding: 16px;
  cursor: pointer;
  font-size: 16px;
...
`;
const Dropdown = yt("div").withConfig({
  shouldForwardProp: (prop) => !["primaryColor", "customCSS", "borderRadius"].includes(prop)
})`
  min-width: 180px;
  max-width: 240px;
...
`;
const DesktopMenuItem = yt("div").withConfig({
...
const ConnectWalletButton = ({
  ...
  const getDefaultButtonTitle = () => {
    if (showAccountBalance) {
      const balanceWithTwoDecimalPlaces = Math.round(accountBalance * 100) / 100;
      return `₳ ${balanceWithTwoDecimalPlaces}`;
    }
    return `${stakeAddress.slice(0, 12)}...`;
  };
  const buttonTitle = stakeAddress && isConnected ? getDefaultButtonTitle() : label || "Connect Wallet";
  const clickStakeAddress = () => {
    if (stakeAddress && isConnected && typeof onStakeAddressClick === "function") {
      onStakeAddressClick(stakeAddress);
    }
  };
  const renderWalletMenu = () => /* @__PURE__ */ jsxRuntimeExports.jsx(Content2, { asChild: true, children: /* @__PURE__ */ jsxRuntimeExports.jsxs(Menu$1, { id: "connect-wallet-menu", children: [
    peerConnectEnabled && /* @__PURE__ */ jsxRuntimeExports.jsx(Item2, { asChild: true, onSelect: () => setShowModalDialog(true), children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
      MenuItem$1,
      {
        gap: 0,
        borderRadius,
    ...
    availableWallets ? availableWallets.map((availableWallet) => {
      ...
      if (isMobile && !mobileWallets.includes(availableWallet.toLowerCase())) {
        return /* @__PURE__ */ jsxRuntimeExports.jsx(Item2, { asChild: true, disabled: true, children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
          DesktopMenuItem,
          {
            borderRadius,
            children: [
    ...
    }) : /* @__PURE__ */ jsxRuntimeExports.jsx("span", { id: "connect-wallet-hint", children: `Please install a wallet browser extension (${formatSupportedWallets(
      supportedWallets
    )} are supported)` })
  ] }) });
  const renderActionMenu = () => hideActionMenu ? null : /* @__PURE__ */ jsxRuntimeExports.jsx(Content2, { asChild: true, children: /* @__PURE__ */ jsxRuntimeExports.jsxs(Menu$1, { id: "connect-wallet-menu", children: [
    typeof message === "string" && /* @__PURE__ */ jsxRuntimeExports.jsx(
      Item2,
      {
        asChild: true,
    ...
    customActions.map((customAction, index) => /* @__PURE__ */ jsxRuntimeExports.jsx(
      Item2,
      {
        asChild: true,
  ...
  if (typeof beforeComponent === "undefined" && enabledWallet) {
    ...
    beforeComponent = /* @__PURE__ */ jsxRuntimeExports.jsx(
      "img",
      {
        height: 24,
        width: 24,
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    Dropdown,
    {
      ...
      children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs(Root2, { children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx(Portal2, { children: !disabled && (isEnabled && isConnected ? renderActionMenu() : renderWalletMenu()) })
        ] })
      ]
    }
  );
...
export { ConnectWalletButton as default };
//# sourceMappingURL=ConnectWalletButton-GnPObxF3.js.map
