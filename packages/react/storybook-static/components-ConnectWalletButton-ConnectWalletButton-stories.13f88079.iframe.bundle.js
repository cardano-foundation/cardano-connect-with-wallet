...
`,DesktopMenuItem=(0,styled_components_browser_esm.ZP)("span").withConfig({shouldForwardProp:prop=>!["borderRadius"].includes(prop)})`
  color: #333;
  position: relative;
  padding: 12px 16px;
  text-decoration: none;
...
//# sourceMappingURL=components-ConnectWalletButton-ConnectWalletButton-stories.13f88079.iframe.bundle.js.map