...
`,MenuItem=(0,styled_components_browser_esm.ZP)("span").withConfig({shouldForwardProp:prop=>!["primaryColor","primaryColorLight","borderRadius","gap"].includes(prop)})`
...
`,MenuItemIcon=styled_components_browser_esm.ZP.img`
  ...
  height: 24px;
  margin-right: 8px;
`,DesktopMenuItem=(0,styled_components_browser_esm.ZP)("span").withConfig({shouldForwardProp:prop=>!["primaryColor","primaryColorLight","borderRadius","gap"].includes(prop)})`
  color: #333;
  position: relative;
  padding: 12px 16px;
  text-decoration: none;
...
//# sourceMappingURL=components-ConnectWalletList-ConnectWalletList-stories.b5cbada9.iframe.bundle.js.map